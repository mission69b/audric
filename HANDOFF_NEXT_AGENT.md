...
**v0.7e Tier C Migration — Phase 1A SHIPPED (S.238, 2026-05-21 ~20:30 AEST)** + **Invoice deprecation kickoff (S.239, 2026-05-21 ~21:00 AEST)** + **Phase 5 RESTORED (S.245, 2026-05-22 ~07:50 AEST — D-2 reframe to full delete)** + **H2 Persistent Chats SHIPPED end-to-end (S.247, 2026-05-22 ~13:00 AEST — Prisma schema + 6 phases + ~30 template-debris files deleted; net ~-6,000 LoC; G1-G5 founder smoke deferred to next deploy)**
