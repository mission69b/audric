...
2. **The next agent-ownable work, in order:**
   ...
   - **(c) PIPELINE-AUDIT-PHASE-2** — S1 ✅ (S.280) + S2 ✅ (S.281) shipped 2026-05-23; S3 + S5 remaining (~2.5-3.5d) from `t2000/spec/active/AUDIT_ON_CHAIN_PIPELINE_2026-05-23.md`. Coordinate with S.272 Lever 2+3 IF they end up shipping (both touch the new `blockvision/` namespace).
