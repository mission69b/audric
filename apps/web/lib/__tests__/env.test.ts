...
function setMinimumValidEnv() {
  ...
  // SPEC 10 B.2: required as of S.69 follow-up. Format-validation lives
  // at the route's `decodeSuiPrivateKey` boundary, not the env schema —
  // the schema gate just enforces "non-empty string."
