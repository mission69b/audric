 ...
 * Duplicated here because @t2000/sdk's main entry bundles Node.js-only deps
 * (fs, @naviprotocol/lending) that can't be resolved in Next.js client builds.
 *
...
export const COIN_REGISTRY: Record<string, CoinMeta> = {
  ...
  HAEDAL:   { type: '0xfda31f48050a04f2130e0e6a81e32b0e7f0f8986aa0ca7aec5d59e4a592fc918::haedal::HAEDAL', decimals: 9, symbol: 'HAEDAL' },
  IKA:      { type: '0xaef8d1e22c07df53c2d1bcfd78d4c3fc5e4e2b1efa0e9c3fb8e3a1c6a2b3d4e5::ika::IKA', decimals: 9, symbol: 'IKA' },
};
...
export function resolveTokenType(nameOrType: string): string | null {
  ...
  for (const [name, meta] of Object.entries(COIN_REGISTRY)) {
    TOKEN_MAP[name] = meta.type;
    TOKEN_MAP[name.toUpperCase()] = meta.type;
  }
