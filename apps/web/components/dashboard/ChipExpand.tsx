...
export const ChipExpand = forwardRef<HTMLDivElement, ChipExpandProps>(
  function ChipExpand({ actions, chipLabel, onSelect, onClose }, ref) {
    return (
      <div
        ref={ref}
        className="absolute left-0 right-0 top-full mt-2 z-50 rounded-xl border border-border bg-surface shadow-lg max-h-[50vh] overflow-y-auto overscroll-contain"
      >
