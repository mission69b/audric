    ...
    >
      {chips.map((chip) => (
        <button
          ...
          className="group relative flex shrink-0 items-center gap-1.5 rounded-full border border-border bg-surface px-3 py-1.5 text-xs font-mono uppercase tracking-wider font-medium text-foreground transition hover:bg-border/30 hover:border-border-bright active:scale-[0.97]"
        >
