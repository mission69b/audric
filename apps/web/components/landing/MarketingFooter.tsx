...
const COMPANY_LINKS = ['About', 'Manifesto', 'Changelog', 'Contact'];
...
export function MarketingFooter() {
  ...
  return (
    <footer className="grid grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1fr] gap-10 lg:gap-12 px-10 pt-16 pb-10 bg-surface-card border-t border-border-subtle max-w-[1200px] mx-auto">
      ...
      <FooterCol heading="Company">
        {COMPANY_LINKS.map((label) => (
          // No URL yet for these — kept as static placeholders to match the
          // marketing handoff. Will become real anchors as pages launch.
          <span key={label} className={`${FOOTER_LINK_CLASS} cursor-default text-fg-muted`}>
            {label}
          </span>
        ))}
      </FooterCol>
      ...
      <div className="col-span-2 lg:col-span-4 border-t border-border-subtle pt-5 mt-3 flex flex-col sm:flex-row justify-between gap-3 font-mono text-[10px] tracking-[0.08em] uppercase text-fg-muted">
