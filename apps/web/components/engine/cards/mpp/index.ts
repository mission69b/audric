 ...
 * the consumer (`TransactionReceiptCard`, B-MPP2). Individual primitives
 * + chrome stay private to this folder so consumers can't accidentally
 * couple to them — every per-vendor decision goes through the registry.
 *
