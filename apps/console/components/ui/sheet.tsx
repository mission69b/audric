...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      className={cn(
        "fixed inset-0 z-50 bg-black/50 data-open:fade-in-0 data-open:animate-in data-closed:fade-out-0 data-closed:animate-out",
        className
      )}
