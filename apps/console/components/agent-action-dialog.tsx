...
> = {
  ...
  unlink: {
    trigger: "Unlink",
    title: (n) => `Unlink ${n}?`,
    body: "Your Passport publicly renounces ownership on-chain. The agent returns to autonomous and leaves your console. Re-linking requires the AGENT to propose again — if its key is lost, unlinking is permanent.",
    liveWarning:
