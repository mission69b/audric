...
function DropdownMenuSubContent({
  ...
  return (
    // Portal so the submenu escapes the parent Content's overflow clipping
    // (the Content scrolls + has transform animations → would clip a non-
    // portaled SubContent, making submenus appear to not open).
    <DropdownMenuPrimitive.Portal>
