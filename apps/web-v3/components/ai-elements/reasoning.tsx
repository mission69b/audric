  ...
  ({ className, children, ...props }: ReasoningContentProps) => {
    ...
    return (
      ...
      >
        ...
        >
          {/* Intentional passthrough of the wrapper's extra attrs; Streamdown
              types a narrower prop set than HTMLDivElement, so cast. */}
          <Streamdown
            plugins={streamdownPlugins}
            {...(props as unknown as ComponentProps<typeof Streamdown>)}
          >
            {children}
          </Streamdown>
        </div>
