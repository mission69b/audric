...
- \`crypto_history\`: daily price HISTORY (OHLCV) over the last N days + a summary (start/end, period high/low, % change). Use for "how has X done this week/month", "X price history / over the last 30 days", or any trend/chart question. Use crypto_market for the current snapshot, crypto_history for the time-series.
