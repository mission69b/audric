...
// ActivitySummaryCard — `activity_summary` tool renderer. Ported from
// `apps/web/components/engine/cards/ActivitySummaryCard.tsx` by Phase
// 5a.4 (renderer migration sweep, 2026-05-19). Verbatim.
