  ...
  switch (template) {
    ...
    case "portfolio_timeline":
      return (
        <PortfolioTimelineCanvas
          data={
            data as Parameters<typeof PortfolioTimelineCanvas>[0]["data"]
          }
          onAction={onAction}
        />
      );
    case "spending_breakdown":
      return (
        <SpendingBreakdownCanvas
          data={
            data as Parameters<typeof SpendingBreakdownCanvas>[0]["data"]
          }
          onAction={onAction}
        />
      );
      ...
      return (
        <div className="flex flex-col items-center justify-center space-y-2 py-10 text-center">
          ...
          <p className="text-fg-secondary text-sm">
            Canvas template &ldquo;{template}&rdquo; is not yet available.
          </p>
        </div>
      );
  }
