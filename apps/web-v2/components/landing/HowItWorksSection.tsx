...
const STEPS = [
  {
    ...
    body: "No seed phrase. No wallet download. Your Audric Passport is ready in 3 seconds via zkLogin.",
  },
  {
    num: "02",
    title: "Just say what you want",
    body: "Save $50, send to alice, what's my health factor? — Audric understands plain English. No menus, no forms.",
  },
  {
    num: "03",
    title: "Confirm, and it's done",
    body: "You see the action, amount, and impact. One tap to confirm — Audric pays the gas, signs the transaction, and shows the result.",
  },
];
