 ...
 *
 * [v0.7e Phase 2 / S.253 — 2026-05-22] Verbatim port from apps/web/lib/billing.ts
 * during the API-route consolidation. Single source of truth — imported by:
 *   - app/api/engine/chat/route.ts  (enforcement at session creation, when ported)
