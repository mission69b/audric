...
export type UserPreferencesWhereInput = {
  ...
  userId?: Prisma.StringNullableFilter<"UserPreferences"> | string | null
...
export type UserPreferencesScalarWhereWithAggregatesInput = {
  ...
  userId?: Prisma.StringNullableWithAggregatesFilter<"UserPreferences"> | string | null
}
...
export type UserPreferencesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"address" | "contacts" | "limits" | "createdAt" | "updatedAt" | "userId", ExtArgs["result"]["userPreferences"]>
...
export interface UserPreferencesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const userPreferencesWithAddressOnly = await prisma.userPreferences.findMany({ select: { address: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserPreferences and only return the `address`
   * const userPreferencesWithAddressOnly = await prisma.userPreferences.createManyAndReturn({
   *   select: { address: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserPreferences and only return the `address`
   * const userPreferencesWithAddressOnly = await prisma.userPreferences.updateManyAndReturn({
   *   select: { address: true },
   *   where: {
   *     // ... provide filter here
   *   },
