...
// biome-ignore lint/suspicious/noControlCharactersInRegex: Intentional — this is the regex that strips control chars from log fields.
...
export function sanitizeForLog(value: unknown): string {
  ...
  if (stripped.length <= MAX_LOG_FIELD_LEN) {
    return stripped;
  }
