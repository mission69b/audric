/**
 * web-v2 copy of `apps/web/lib/identity/reserved-usernames.ts`.
 *
 * Intentional duplicate during v0.7c Phase 6 — apps/web is the SSOT
 * until the v0.7e deletion sweep removes it. Until then: edit BOTH
 * copies together (RUNBOOK §7 + this file + apps/web/lib/identity/
 * reserved-usernames.ts). Drift between the two is a bug. Same
 * pattern as `lib/prisma.ts` cross-package coupling.
 *
 * Original docs preserved below for ground-truth lookup.
 *
 * --- ORIGINAL HEADER ---
 *
