      ...
      <div className="space-y-10 text-muted-foreground leading-[1.7] text-[14px]">
        <section>
          ...
          <p>
            ...
            audric.ai, you agree to these Terms of Service. If you do not agree,
        ...
        <section>
          ...
          <p>
            Audric sponsors gas fees for all transactions via Mysten Labs Enoki.
            This is a convenience feature and may be modified, rate-limited, or
        ...
        <section>
          ...
          <p className="uppercase text-xs leading-relaxed">
            ...
            funds, whether in contract, tort, or otherwise, arising out of or in
            connection with your use of the Service. This includes but is not
            limited to losses from AI recommendations, DeFi protocol
