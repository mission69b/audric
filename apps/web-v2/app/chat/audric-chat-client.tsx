    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        {/* [2026-05-31] vercel/chatbot chat-shell frame: the outer column is
            ...
            conversation panel below is a bg-background region with a rounded
            top-left corner + top/left border that tucks under the header (md+).
            This is the single always-on rounded border (the SidebarRail's
            hover-reveal duplicate was removed to kill the double-line bug). */}
