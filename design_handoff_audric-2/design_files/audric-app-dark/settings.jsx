  ...
  <div>
    ...
    <Card pad={16} style={{background:'var(--panel-2)'}}>
      ...
      <div style={{display:'flex',alignItems:'center',gap:8}}>
        ...
        <input defaultValue="1" style={{width:60,padding:'8px 10px',border:'1px solid var(--line-2)',borderRadius:4,fontFamily:'var(--font-sans)',fontSize:13,background:'var(--panel-2)'}}/>
