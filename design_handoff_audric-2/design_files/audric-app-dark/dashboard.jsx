  ...
  return (
    <div style={{position:'relative',height:'100%',overflow:'hidden'}}>
      ...
      <div style={{position:'absolute',top:'50%',left:'50%',transform:'translate(-50%,-50%)',width:'calc(100% - 160px)',maxWidth:700,display:'flex',flexDirection:'column',alignItems:'stretch'}}>
        ...
        {/* Composer */}
        <div style={{background:'var(--panel-2)',border:'1px solid var(--line)',borderRadius:8,padding:'16px'}}>
          ...
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <div style={{display:'flex',gap:8,alignItems:'center'}}>
              ...
              <button onClick={send} style={{width:28,height:28,borderRadius:'50%',background:draft.trim()?'var(--text)':'var(--line)',color:draft.trim()?'var(--on-text)':'var(--text-3)',display:'grid',placeItems:'center'}}>
...
const SwapTranscript = () => (
  <div style={{maxWidth:700,margin:'24px auto 0',display:'flex',flexDirection:'column',gap:14}}>
    ...
    {/* user bubble — pure black, matching Figma chat frame */}
    <div style={{alignSelf:'flex-end',background:'var(--panel-2)',color:'var(--text)',padding:'8px 14px',borderRadius:999,fontSize:14,border:'1px solid var(--line)'}}>swap 1 usd to sui</div>
