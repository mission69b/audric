    ...
    <div style={{display:'grid',gridTemplateColumns:'280px 1fr',height:'100%',overflow:'hidden'}}>
      ...
      <aside style={{borderRight:'1px solid var(--line)',background:'var(--panel-2)',display:'flex',flexDirection:'column',overflow:'hidden'}}>
        ...
        <div style={{padding:'6px 16px 10px'}}>
          <div style={{display:'flex',alignItems:'center',gap:8,border:'1px solid var(--line)',borderRadius:8,padding:'8px 10px',background:'var(--panel-2)'}}>
      ...
      <section style={{overflow:'auto',padding:'28px 48px'}}>
        ...
        <div style={{maxWidth:640,margin:'8px auto 0'}}>
          ...
          <button className="mono" style={{width:'100%',marginTop:20,padding:'14px 20px',borderRadius:999,background:'var(--text)',color:'var(--on-text)',fontSize:11,letterSpacing:'.1em',display:'flex',justifyContent:'center',alignItems:'center',gap:8}}>
            SEND → 
          </button>
