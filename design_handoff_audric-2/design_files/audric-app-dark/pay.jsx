  ...
  return (
    <div style={{padding:'24px 32px',overflow:'auto',height:'100%',display:'flex',flexDirection:'column',gap:18,maxWidth:820,margin:'0 auto',width:'100%'}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr auto',gap:8}}>
        <button className="mono" style={{padding:'14px 20px',borderRadius:999,background:'var(--text)',color:'var(--on-text)',fontSize:11,letterSpacing:'.1em'}}>+ PAYMENT LINK</button>
