...
const Sidebar = ({ route, setRoute, collapsed, setCollapsed }) => {
  ...
  if (collapsed) {
    return (
      <aside style={{width:48,flex:'0 0 48px',borderRight:'1px solid var(--line)',background:'var(--panel-2)',display:'flex',flexDirection:'column',alignItems:'center',padding:'14px 0',gap:4}}>
  ...
  return (
    <aside style={{width:240,flex:'0 0 240px',borderRight:'1px solid var(--line)',background:'var(--panel-2)',display:'flex',flexDirection:'column'}}>
      {/* Brand */}
